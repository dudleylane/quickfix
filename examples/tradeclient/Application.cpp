...
FIX40::NewOrderSingle Application::queryNewOrderSingle40()
{
    ...
    FIX40::NewOrderSingle newOrderSingle(queryClOrdID(), FIX::HandlInst('1'), querySymbol(), querySide(),
...
FIX41::NewOrderSingle Application::queryNewOrderSingle41()
{
    ...
    FIX41::NewOrderSingle newOrderSingle(queryClOrdID(), FIX::HandlInst('1'), querySymbol(), querySide(),
...
FIX42::NewOrderSingle Application::queryNewOrderSingle42()
{
    ...
    FIX42::NewOrderSingle newOrderSingle(queryClOrdID(), FIX::HandlInst('1'), querySymbol(), querySide(),
...
FIX43::NewOrderSingle Application::queryNewOrderSingle43()
{
    ...
    FIX43::NewOrderSingle newOrderSingle(queryClOrdID(), FIX::HandlInst('1'), querySide(), FIX::TransactTime(),
                                         ordType = queryOrdType());
...
{
    FIX40::OrderCancelRequest orderCancelRequest(queryOrigClOrdID(), queryClOrdID(), FIX::CxlType('F'), querySymbol(),
                                                 querySide(), queryOrderQty());
...
{
    FIX42::OrderCancelRequest orderCancelRequest(queryOrigClOrdID(), queryClOrdID(), querySymbol(), querySide(),
                                                 FIX::TransactTime());
...
{
    FIX40::OrderCancelReplaceRequest cancelReplaceRequest(queryOrigClOrdID(), queryClOrdID(), FIX::HandlInst('1'),
...
{
    FIX41::OrderCancelReplaceRequest cancelReplaceRequest(queryOrigClOrdID(), queryClOrdID(), FIX::HandlInst('1'),
...
{
    FIX42::OrderCancelReplaceRequest cancelReplaceRequest(queryOrigClOrdID(), queryClOrdID(), FIX::HandlInst('1'),
                                                          querySymbol(), querySide(), FIX::TransactTime(),
                                                          queryOrdType());
...
{
    FIX43::OrderCancelReplaceRequest cancelReplaceRequest(queryOrigClOrdID(), queryClOrdID(), FIX::HandlInst('1'),
...
{
    FIX44::OrderCancelReplaceRequest cancelReplaceRequest(queryOrigClOrdID(), queryClOrdID(), querySide(),
...
{
    FIX50::OrderCancelReplaceRequest cancelReplaceRequest(queryOrigClOrdID(), queryClOrdID(), querySide(),
                                                          FIX::TransactTime(), queryOrdType());
