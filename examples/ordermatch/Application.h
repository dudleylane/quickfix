...
class Application : public FIX::Application, public FIX::MessageCracker
{
    ...
    void rejectOrder(const FIX::SenderCompID &, const FIX::TargetCompID &, const FIX::ClOrdID &clOrdID,
                     const FIX::Symbol &symbol, const FIX::Side &side, const std::string &message);
