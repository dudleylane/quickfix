...
MessageStore *MessageStoreFactoryExceptionWrapper::create(const UtcTimeStamp &now, const SessionID &sessionID,
...
void MessageStoreExceptionWrapper::get(SEQNUM begin, SEQNUM end, std::vector<std::string> &msgs, bool &threw,
