...
TEST_CASE("MessageTests")
{
    ...
    SECTION("rejectGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=36\00135=3\00145=73\001"
              "58=This Message SUCKS!!!\00110=029\001" == object.toString());
    }
    ...
    SECTION("newOrderSingleGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=60\00135=D\00111=ORDERID\00121=3\00140=2\001"
              "54=1\00155=MSFT\00160=19000101-00:00:00\00110=226\001" == object.toString());
    }
    ...
    SECTION("executionReportGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=77\00135=8\0016=23.4\00114=300\001"
              "17=EXECID\00120=1\00137=ORDERID\00139=3\00154=4\00155=MSFT\001"
              "150=2\001151=200\00110=052\001" == object.toString());
    }
    ...
    SECTION("dontKnowTradeGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=45\00135=Q\00117=EXECID\00137=ORDERID\001"
              "54=2\00155=MSFT\001127=1\00110=195\001" == object.toString());
    }
    ...
    SECTION("orderCancelReplaceGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=75\00135=G\00111=CLIENTID\00121=1\001"
              "40=3\00141=ORIGINALID\00154=2\00155=MSFT\001"
              "60=19000101-00:00:00\00110=179\001" == object.toString());
    }
    ...
    SECTION("orderCancelRequestGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=65\00135=F\00111=CLIENTID\00141=ORIGINALID\001"
              "54=1\00155=MSFT\00160=19000101-00:00:00\00110=009\001" == object.toString());
    }
    ...
    SECTION("orderCancelRejectGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=53\00135=9\00111=CLIENTID\00137=ORDERID\001"
              "39=1\00141=ORIGINALID\001434=2\00110=229\001" == object.toString());
    }
    ...
    SECTION("orderStatusRequestGetString")
    {
        ...
        CHECK("8=FIX.4.2\0019=30\00135=H\00111=CLIENTID\00154=1\001"
              "55=MSFT\00110=141\001" == object.toString());
    }
    ...
    SECTION("newOrderListGetString")
    {
        ...
        CHECK(("8=FIX.4.2\0019=95\00135=E\00166=1\00168=3\00173=3\001"
    ...
    SECTION("newOrderListSetString")
    {
        ...
        object.setString("8=FIX.4.2\0019=95\00135=E\00166=1\00168=3\00173=3\001"
        ...
        object.setString("8=FIX.4.2\0019=26\00135=E\00166=1\00168=3\00173=0\001"
                         "394=0\00110=137\001",
                         true, &dataDictionary);
    }
    ...
    SECTION("massQuoteParseGetString")
    {
        ...
        CHECK(("8=FIX.4.2\0019=54\00135=i\001117=1\001296=1\001302=A\001"
    ...
    SECTION("massQuoteSetString")
    {
        ...
        object.setString("8=FIX.4.2\0019=54\00135=i\001117=1\001296=1\001302=A\001"
    ...
    SECTION("newOrderCrossGetString")
    {
        ...
        CHECK(("8=FIX.4.4\0019=75\00135=s\001552=1\00154=1\001453=2\001448=PARTY1\001"
    ...
    SECTION("newOrderCrossSetString")
    {
        ...
        object.setString("8=FIX.4.4\0019=75\00135=s\001552=1\00154=1\001453=2\001448=PARTY1\001"
    ...
    SECTION("allocationInstructionParseGetString")
    {
        ...
        CHECK("8=FIX.4.4\0019=121\00135=J\00134=1\00149=SENDER\00156=TARGET\001627=2\001"
    ...
    SECTION("allocationInstructionString")
    {
        ...
        object.setString("8=FIX.4.4\0019=198\00135=J\00134=1\00149=SENDER\00152=20170317-15:55:23.685\001"
    ...
    SECTION("setString_TrailerStructureInvalid_MessageStructureInvalid")
    {
        ...
        std::string rawFixMsg = "8=FIX.4.2" + delimSOH + "9=200" + delimSOH + "35=A" + delimSOH + "49=SENDER" +
                                delimSOH + "56=TARGET" + delimSOH + "34=1" + delimSOH + "98=0" + delimSOH + "10=200" +
    ...
    SECTION("setString_SignatureInTrailerWithoutSignatureLength_InvalidMessageException")
    {
        ...
        std::string delimSOH = "\x01";
        std::string rawFixMsg = "8=FIX.4.2" + delimSOH + "9=200" + delimSOH + "35=A" + delimSOH + "49=SENDER" +
                                delimSOH + "56=TARGET" + delimSOH + "34=1" + delimSOH + "98=0" + delimSOH + "108=30" +
                                delimSOH + "89=200" + delimSOH // Signature
                                + "10=200" + delimSOH;
    ...
    SECTION("setStringAndValidate_IncorrectBodyLength_InvalidException")
    {
        ...
        std::string rawFixMsg = "8=FIX.4.2" + delimSOH + "9=2000" + delimSOH // Incorrect BodyLength
                                + "35=A" + delimSOH + "49=SENDER" + delimSOH + "56=TARGET" + delimSOH + "34=1" +
                                delimSOH + "98=0" + delimSOH + "108=30" + delimSOH + "10=200" + delimSOH;
