...
{
    fileStoreFixture(bool resetBefore, bool reset) : factory("store")
    {
        if (resetBefore)
        {
...
TEST_CASE_METHOD(resetBeforeFileStoreFixture,
                 "resetFileStoreTests"){SECTION("setGet"){CHECK_MESSAGE_STORE_SET_GET}
