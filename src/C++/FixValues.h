...
const char YieldType_FIX4n_YIELD_VALUE_OF32NDS[] = "VALUE1/32";
...
const char MatchType_FIX50ONLY_ONE_PARTY_PRIVATELY_NEGOTIATED_TRADE_REPORT[] = "60";
const char MatchType_FIX50ONLY_TWO_PARTY_PRIVATELY_NEGOTIATED_TRADE_REPORT[] = "61";
const char MatchType_FIX50ONLY_CONTINUOUS_AUTO_MATCH[] = "62";
const char MatchType_FIX50ONLY_CROSS_AUCTION[] = "63";
const char MatchType_FIX50ONLY_COUNTER_ORDER_SELECTION[] = "64";
const char MatchType_FIX50ONLY_CALL_AUCTION[] = "65";
