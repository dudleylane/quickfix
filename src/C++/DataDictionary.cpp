...
DataDictionary::DataDictionary()
    : m_hasVersion(false), m_checkFieldsOutOfOrder(true), m_checkFieldsHaveValues(true), m_checkUserDefinedFields(true),
      m_allowUnknownMessageFields(false), m_storeMsgFieldsOrder(false)
{
}

DataDictionary::DataDictionary(std::istream &stream, bool preserveMsgFldsOrder) EXCEPT(ConfigError)
    : m_hasVersion(false), m_checkFieldsOutOfOrder(true), m_checkFieldsHaveValues(true), m_checkUserDefinedFields(true),
      m_allowUnknownMessageFields(false), m_storeMsgFieldsOrder(preserveMsgFldsOrder)
{
...
DataDictionary::DataDictionary(const std::string &url, bool preserveMsgFldsOrder) EXCEPT(ConfigError)
    : m_hasVersion(false), m_checkFieldsOutOfOrder(true), m_checkFieldsHaveValues(true), m_checkUserDefinedFields(true),
      m_allowUnknownMessageFields(false), m_storeMsgFieldsOrder(preserveMsgFldsOrder), m_orderedFieldsArray(0)
{
    readFromURL(url);
}
                              ...
                              const DataDictionary *const pAppDD) EXCEPT(FIX::Exception)
{
    ...
    int outOfOrderGroupField = 0;
    if (message.hasOutOfOrderGroupMembers(outOfOrderGroupField))
    {
        throw OutOfOrderGroupMembers(outOfOrderGroupField);
    }
