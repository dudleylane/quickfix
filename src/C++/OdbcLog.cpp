...
OdbcLog::OdbcLog(const SessionID &s, const std::string &user, const std::string &password,
...
OdbcLogFactory::OdbcLogFactory(const std::string &user, const std::string &password,
                               const std::string &connectionString)
    : m_user(user), m_password(password), m_connectionString(connectionString), m_useSettings(false)
{
}

OdbcLogFactory::OdbcLogFactory()
    : m_user(DEFAULT_USER), m_password(DEFAULT_PASSWORD), m_connectionString(DEFAULT_CONNECTION_STRING),
      m_useSettings(false)
{
}
...
void OdbcLogFactory::init(const Dictionary &settings, std::string &user, std::string &password,
                          std::string &connectionString)
{
    user = DEFAULT_USER;
